...
pygame.mixer.music.load("asset/sounds/bgm.mp3")
...
#音
fire_se = pygame.mixer.Sound("asset/sounds/fire.mp3")
shot_se = pygame.mixer.Sound("asset/sounds/shot.mp3")
win_se  = pygame.mixer.Sound("asset/sounds/seikou.mp3")
lose_se = pygame.mixer.Sound("asset/sounds/sippai.mp3")

start_sound_played = False
start_se = pygame.mixer.Sound("asset/sounds/start.mp3")
