...
# ====================== ÂM THANH ================================
pygame.mixer.music.load("sound/FrenchPop_01.mp3")
pygame.mixer.music.set_volume(0.5)
pygame.mixer.music.play(-1)

point_sound = pygame.mixer.Sound("sound/決定3.mp3")
hit_sound = pygame.mixer.Sound("sound/ツッコミ打撃2.mp3")
fall_sound = pygame.mixer.Sound("sound/ゲームオーバー.mp3")
start_sound1 = pygame.mixer.Sound("sound/笛ピッピー2.mp3")
start_sound_2 = pygame.mixer.Sound("sound/はじまるよ.mp3")
click_sound = pygame.mixer.Sound("sound/振り回す1.mp3")
