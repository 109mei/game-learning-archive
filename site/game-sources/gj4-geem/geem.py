...
def load_game_sound():
    candidates = ["1.mp3", "1.wav", "shot.mp3", "shot.wav", "shot.ogg"]
...
# UI用フォント
font = pygame.font.SysFont(["notosanscjkjp", "msgothic"], 42, bold=True)
title_font = pygame.font.SysFont(["notosanscjkjp", "msgothic"], 48, bold=True)
