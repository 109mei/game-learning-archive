...
BGM_menu="asset/効果音・BGM/menu.ogg"
BGM_rule="asset/効果音・BGM/rule.ogg"
BGM_game="asset/効果音・BGM/game.ogg"
choose_sound=pygame.mixer.Sound("asset/効果音・BGM/14.ogg")
choose_sound.set_volume(0.3)
decision_sound=pygame.mixer.Sound("asset/効果音・BGM/6.ogg")
decision_sound.set_volume(0.3)
start_sound=pygame.mixer.Sound("asset/効果音・BGM/13.ogg")
start_sound.set_volume(0.3)
accel_sound=pygame.mixer.Sound("asset/効果音・BGM/10.ogg")
accel_sound.set_volume(0.3)
damage_sound=pygame.mixer.Sound("asset/効果音・BGM/1.ogg")
damage_sound.set_volume(0.3)
get_coin_sound=pygame.mixer.Sound("asset/効果音・BGM/7.ogg")
get_coin_sound.set_volume(0.3)
get_heart_sound=pygame.mixer.Sound("asset/効果音・BGM/5.ogg")
...
async def _web_main():
    global Fall_judgment, HP, all, ceiling, character, character_fall_img, choice, coin, collide, event, gap, heart, hearts, high_score, i, interval, keep_point, keys, last_point, last_scine, last_speed, level, message, messages, msg, point, random_x, random_y, resistance, running, scenery_img_1, scenery_img_2, scenery_img_3, scenerys, scine, shougaibutu, shougaibutu_previous_time, speed, text_surface, tutorial_page
