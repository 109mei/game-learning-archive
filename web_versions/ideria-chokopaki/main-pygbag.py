...
def _web_log(msg):
    try:
        ...
        _pf.window.console.log("WEBPROBE: " + str(msg))
    except Exception:
        pass
_web_log('module start')
# coding: utf-8
import os
import sys
import pygame
...
display_flags = getattr(pygame, "SCALED", 0)  # web: FULLSCREEN解除
try:
    screen=pygame.display.set_mode((scr_w,scr_h),display_flags)
except pygame.error:
    screen=pygame.display.set_mode((scr_w,scr_h))
_web_log("P1 set_mode done")
...
# 透過度の初期値
alpha = 128
_web_log("P2 first image load start")
...
#サウンド読み込み
choko1_sound=load_sound("choko1.ogg")
choko2_sound=load_sound("choko2.ogg")
choko3_sound=load_sound("choko3.ogg")
choko4_sound=load_sound("choko4.ogg")
choko5_sound=load_sound("choko5.ogg")
choko6_sound=load_sound("choko6.ogg")
choko7_sound=load_sound("choko7.ogg")
choko8_sound=load_sound("choko8.ogg")
choko9_sound=load_sound("choko9.ogg")
choko10_sound=load_sound("choko10.ogg")
choko11_sound=load_sound("choko11.ogg")
choko12_sound=load_sound("choko12.ogg")
choko13_sound=load_sound("choko13.ogg")
choko14_sound=load_sound("choko14.ogg")
choko15_sound=load_sound("choko15.ogg")
choko16_sound=load_sound("choko16.ogg")
choko17_sound=load_sound("choko17.ogg")
choko18_sound=load_sound("choko18.ogg")
choko19_sound=load_sound("choko19.ogg")
choko20_sound=load_sound("choko20.ogg")
choko21_sound=load_sound("choko21.ogg")
randomsound=1
...
async def _web_main():
    global AIplay, AIplaylist, AIsentaku1, AIsentaku2, AIsentaku3, AIsentaku4, AIsentaku5, AIsentaku6, AIsentaku7, AIsentakukaisuu1, AIsentakukaisuu2, AIsentakukaisuu3, AIsentakukaisuu4, AIsentakukaisuu5, AIsentakukaisuu6, AIsentakukaisuu7, AIturn, aitokuten, aitokuten1, aitokutensougou, aki, aki1, alpha, angle, atari_migi1, atari_migi2, atari_sita1, atari_sita2, atari_sita3, atari_sita4, atari_sita5, ataru_a, ataru_x, ataru_y, butann_Retry, butann_Title, butann_asobikata_batu, butann_asobikata_hidari, butann_asobikata_migi, butann_migi1, butann_migi1_sakujo, butann_migi2, butann_migi2_sakujo, butann_sita1, butann_sita1_sakujo, butann_sita2, butann_sita2_sakujo, butann_sita3, butann_sita3_sakujo, butann_sita4, butann_sita4_sakujo, butann_sita5, butann_sita5_sakujo, butann_title_asobi, butann_title_easy, butann_title_hajime, butann_title_hard, c, cell, choko, choko1randomchoko_x, choko1randomchoko_x1, choko1randomchoko_y, choko1randomchoko_y1, choko_moto, choko_sound, choko_yosoku, choko_yosoku_1, choko_yosoku_2, choko_yosoku_3, choko_yosoku_4, choko_yosoku_5, choko_yosoku_6, choko_yosoku_7, choko_yosoku_toki, combined_image, combined_image1, d, event, font, game, gyaku, gyaku_hantei, hantei, hyouji, i, kaiten_height, kaiten_height1, kaiten_width, kaiten_width1, kakutei, kasorux, kasoruy, left_margin, left_margin1, margin_height, margin_width, migisita, nannido, playr, playrtokuten, playrtokuten1, playrtokutensougou, q, randomchoko_x, randomchoko_x1, randomchoko_y, randomchoko_y1, randomsound, rotated_image, rotated_image1, rotated_rect, rotated_rect1, rotation_angle, roundsuu, row, running, saikousentaku, scene, senkou, sentaku, sentakusuu, suuji, suuji1, suuji2, suuji3, syouri, tennsuukioku, tennsuukioku1, text10, text11, text7, tomeru, tomeru1, tomeru2, top_margin, total_cell_width, total_cell_width1, tumeru, tumeru_kaiten, tumeru_kaiten1, tumeru_tate, tumeru_tate1, tumeru_tate2, x, y, yoserumigi, yoserusita, yosoku, yosoku_hituyou, z
    _web_log('enter while game')
    while game:
        ...
        font = pygame.font.Font("_webfont.ttf", 100)
