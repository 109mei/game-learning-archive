...
# 効果音・BGM
test_se5 = pygame.mixer.Sound("asset/効果音/5.ogg")
test_se6 = pygame.mixer.Sound("asset/効果音/6.ogg")
test_se10 = pygame.mixer.Sound("asset/効果音/10.ogg")
test_se5.set_volume(0.8)
test_se10.set_volume(0.6)

test_se4 = pygame.mixer.Sound("asset/効果音/4.ogg")
...
async def _web_main():
    global HP, dist, dnote, dt, elapsed_time, event, guide, guide2, guide3, guide4, guide5, hyouzi_time, img, last_spawn, message, msg_surface1, msg_surface2, msg_surface3, msg_surface_hp, note, point, rect, remain_ms, result, running, scene, title
    while running:
