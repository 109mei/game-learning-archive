...
MUSIC_FILES = ["5(1).ogg", "1.ogg", "2.ogg"]
...
class AudioManager:
    def __init__(self):
        ...
        try:
            ...
            self.sfx = {
                "start": pg.mixer.Sound(os.path.join(AUDIO_DIR, "13.ogg")),
                "game_over": pg.mixer.Sound(os.path.join(AUDIO_DIR, "4.ogg")),
                "booster": pg.mixer.Sound(os.path.join(AUDIO_DIR, "5.ogg")),
                "coin": pg.mixer.Sound(os.path.join(AUDIO_DIR, "6.ogg")),
            }
...
async def _web_main():
    global button, dt, event, i, pos, running, state
    while running:
